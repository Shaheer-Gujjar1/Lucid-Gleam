            ...
            <div className="flex h-16 items-center justify-between gap-4 px-6">
              ...
              <div className="flex-1 max-w-md hidden md:block">
                <div className="relative cursor-pointer group" onClick={() => setSearchOpen(true)}>
                  ...
                  <Input placeholder="Search... (⌘K)" className="pl-10 glass border-border/30 focus:border-primary/50 hover:border-primary/30 transition-all duration-300 cursor-pointer" readOnly />
                </div>
              </div>
      ...
      <CommandDialog open={searchOpen} onOpenChange={setSearchOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Classes">
            {classes.slice(0, 5).map(cls => <CommandItem key={cls.id} onSelect={() => {
